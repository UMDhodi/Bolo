...
import { a as onAuthStateChanged, c as signInWithPopup, i as getAuth, l as signOut, n as RecaptchaVerifier, o as signInWithEmailAndPassword, r as createUserWithEmailAndPassword, s as signInWithPhoneNumber, t as GoogleAuthProvider, u as updateProfile } from "../_libs/firebase__auth.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CfhLwi9k.js
...
async function sendPhoneOTP(phoneNumber, appVerifier) {
	return await signInWithPhoneNumber(auth, phoneNumber, appVerifier);
}
async function verifyPhoneOTP(confirmationResult, code, displayName) {
	const credential = await confirmationResult.confirm(code);
	if (displayName && credential.user) await updateProfile(credential.user, { displayName });
	try {
		if (credential.user) await set(ref(db, `users/${credential.user.uid}`), {
			uid: credential.user.uid,
...
var $$splitComponentImporter$3 = () => import("./routes-BkrbGQSJ.mjs");
...
var $$splitComponentImporter$2 = () => import("./auth-D1hXxAXA.mjs");
var Route$2 = createFileRoute("/auth")({
	head: () => ({ meta: [{ title: "Welcome to Bolo" }] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./explore-XNf89ocD.mjs");
...
var $$splitComponentImporter = () => import("./raise-DqP53Pzp.mjs");
...
//#endregion
export { LANGUAGES as C, useT as S, updateUserProfile as _, createRecaptchaVerifier as a, initAutoLocationDetection as b, getUserIssueCount as c, signInToBolo as d, signInWithGoogle as f, updateIssue as g, subscribeToIssues as h, createBoloAccount as i, getUserProfile as l, submitIssue as m, Route as n, deleteIssue as o, signOutOfBolo as p, useAuth as r, getFirebaseErrorMessage as s, router_exports as t, sendPhoneOTP as u, verifyPhoneOTP as v, t as w, useLanguage as x, getCachedUserLocation as y };
